...
class RegisterNewUser(unittest.TestCase):
    ...
    def test_new_user(self):
        driver = self.driver
        driver.find_element_by_xpath('/html/body/div[2]/div[2]/header/div/div[2]/div/a/span[2]')
        driver.find_element_by_link_text('Log In').click()

        create_account_button = driver.find_element_by_xpath('/html/body/div[2]/div[2]/div[2]/div/div/div[2]/form/div/div[1]/div[2]/a/span/span')
